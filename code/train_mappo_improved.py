...
# ==========================================
def train():
    parser = argparse.ArgumentParser(description="VMAS MAPPO Improved")
    ...
    print(f"MAPPO (Improved) Running on device: {device}")
    ...
    np.save("rewards_mappo_improved.npy", np.array(all_episode_rewards))
    torch.save(agent.state_dict(), "mappo_transport_improved.pth")
    print("MAPPO Improved Finished. Data saved to rewards_mappo_improved.npy")
